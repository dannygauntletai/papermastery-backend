...
async def mock_generate_learning_content_json(prompt: str, max_tokens: int = 2500, temperature: float = 0.3) -> Dict[str, Any]:
    """
    Mock function for generating learning content JSON for TESTING ONLY.
    ...
    Returns:
        A dictionary containing structured learning content
        
    Raises:
        RuntimeError: If called in a production environment
    """
    if os.getenv("ENVIRONMENT", "development") == "production":
        logger.error("mock_generate_learning_content_json called in production environment")
        raise RuntimeError("mock_generate_learning_content_json should not be used in production")
        
    logger.warning("Using mock learning content generation - FOR TESTING ONLY")
    
    # Return a mock response
    return {
        "methodology": {
            "title": "Mock Methodology",
            "content": "This is a mock methodology section for testing purposes. It simulates the content that would be generated by the LLM."
        },
        "results": {
            "title": "Mock Results",
            "content": "This is a mock results section for testing purposes. It simulates the content that would be generated by the LLM."
        },
        "key_concepts": [
            {
                "key_concept": "First Mock Concept",
                "explainer": "This is a mock explanation of the first key concept for testing purposes."
            },
            {
                "key_concept": "Second Mock Concept",
                "explainer": "This is a mock explanation of the second key concept for testing purposes."
            },
            {
                "key_concept": "Third Mock Concept",
                "explainer": "This is a mock explanation of the third key concept for testing purposes."
            }
        ]
    }
